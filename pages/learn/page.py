import os
import shutil
from PySide6.QtWidgets import QWidget, QVBoxLayout, QLabel, QPushButton, QFileDialog, QMessageBox, QComboBox, QListWidget, QInputDialog
from pages.learn.learn import run_learn
...
class LearnPage(QWidget):
    ...
    def run_learn_function(self):
        ...
        result = run_learn(metadatafile=metadata_file_path, datafile=csv_file_path, outputdir=outputdir, seed=16, parallel=12)
